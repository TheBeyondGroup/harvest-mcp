  ...
  return c.html(`
    ...
    <html lang="en">
      <head>
        ...
        <title>Harvest MCP — The Beyond Group</title>
        <meta name="description" content="The Beyond Group's hosted Harvest MCP server — connect Harvest time tracking to Claude via claude.ai Connectors.">

        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="https://harvest-mcp.thebeyondgroup.la/">
        <meta property="og:title" content="Harvest MCP — The Beyond Group">
        <meta property="og:description" content="The Beyond Group's hosted Harvest MCP server. Connect Harvest to Claude via claude.ai Connectors.">
        <meta property="og:image" content="https://harvest-mcp.thebeyondgroup.la/og-image.png">
        <meta property="og:image:width" content="1200">
        <meta property="og:image:height" content="630">

        <!-- Twitter -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:url" content="https://harvest-mcp.thebeyondgroup.la/">
        <meta name="twitter:title" content="Harvest MCP — The Beyond Group">
        <meta name="twitter:description" content="The Beyond Group's hosted Harvest MCP server. Connect Harvest to Claude via claude.ai Connectors.">
        <meta name="twitter:image" content="https://harvest-mcp.thebeyondgroup.la/og-image.png">

        <link rel="canonical" href="https://harvest-mcp.thebeyondgroup.la/">
      ...
      <body>
        <header>
          ...
          <div class="header-links">
            <a href="https://github.com/TheBeyondGroup/harvest-mcp#available-tools-21" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
              21 Tools
            </a>
            <a href="https://github.com/TheBeyondGroup/harvest-mcp" target="_blank">
        ...
        <main>
          <section class="hero">
            <h1>Connect <span>Harvest</span> to Claude</h1>
            <p class="hero-description">
              The Beyond Group's hosted Harvest MCP server. Paste the URL into claude.ai Connectors, OAuth your Harvest account, and query your time tracking from any Claude surface.
            </p>
          </section>
        ...
        <footer>
          <div class="made-with">
            Maintained by <a href="https://thebeyondgroup.la" target="_blank">The Beyond Group</a> · Forked from <a href="https://github.com/southleft/harvest-mcp" target="_blank">Southleft</a>
          </div>
          <div class="footer-links">
            <a href="https://github.com/TheBeyondGroup/harvest-mcp" target="_blank">GitHub</a>
...
app.get('/og-image.png', (c) => {
  const svg = `<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="180" y="290" font-family="system-ui, -apple-system, sans-serif" font-size="28" fill="#525252">The Beyond Group · Connect Harvest to Claude</text>
    ...
    <text x="80" y="460" font-family="system-ui, -apple-system, sans-serif" font-size="18" fill="#A3A3A3">harvest-mcp.thebeyondgroup.la</text>
  </svg>`;
...
app.get('/.well-known/oauth-protected-resource', (c) => {
  ...
  return c.json({
    ...
    resource_documentation: 'https://github.com/TheBeyondGroup/harvest-mcp',
  });
});
...
app.get('/.well-known/oauth-authorization-server', (c) => {
  ...
  return c.json({
    ...
    service_documentation: 'https://github.com/TheBeyondGroup/harvest-mcp',
  });
});
